...
%\AtBeginDocument{% 
        ...
        \renewcommand{\lstlistlistingname}{Spis listingw}%
}%} 
...
%\AtBeginDocument{% 
        \addto\captionspolish{% 
        \renewcommand{\listfigurename}{Spis rysunkw}% 
}%}
...
\parbox{\linewidth-2.0\absleftindent}{
       \iflanguage{polish}{\textbf{Sowa kluczowe:} #1}{%
...
{\fontsize{26pt}{28pt}\selectfont I}NYNIERSKA}\\[2.5cm]
}
\vfill
{\centering
...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Szablon pracy dyplomowej inynierskiej/magisterskiej, wersja 0.7}
...
\specjalnosc{Inynieria systemw informatycznych}
\promotor{tytu/stopie naukowy, Imi Nazwisko}
\date{WROCAW, 2021}
...
\maketitle
\clearpage
% INFO: Strona z licencj CC zdefiniowana poniej dotyczy tylko zredagowanej treci. 
%       Z samego szablon mona korzystywa bez koniecznoci cytowania jego autora.
%       Podczas pisania pracy dyplomowej stron t mona usun (a nawet naley).
\thispagestyle{empty}
\mbox{}\vfill
...
{\normalfont 
Tekst zawarty w niniejszym szablonie jest udostpniany na licencji Creative Commons: \emph{Uznanie autorstwa -- Uycie niekomercyjne -- Na tych samych warunkach, 3.0 Polska}, Wrocaw 2021. \\[2pt]
Oznacza to, e wszystkie przekazane treci mona kopiowa i  wykorzystywa do celw niekomercyjnych, a take tworzy na ich podstawie utwory zalene pod warunkiem podania autora i~nazwy licencjodawcy oraz udzielania na utwory zalene takiej samej licencji. Tekst licencji jest dostpny pod adresem: \url{http://creativecommons.org/licenses/by-nc-sa/3.0/pl/}.\\[2pt]
Podczas redakcji pracy dyplomowej stron t mona usun. Licencja dotyczy bowiem zredagowanego opisu, a nie samego latexowego szablonu. Latexowy szablon mona wykorzystywa bez wzmiankowania o jego autorze. 
}
\clearpage
...
\clearpage
\pdfbookmark[0]{Spis treci}{spisTresci.1}%
%%\phantomsection
%%\addcontentsline{toc}{chapter}{Spis treci}
\tableofcontents* 
\clearpage
\pdfbookmark[0]{Spis rysunkw}{spisRysunkow.1} % jeli chcemy mie w spisie treci, to zamarkowa t lini, a odmarkowa linie ponisze
%%\phantomsection
...
\listoftables*
\clearpage
\pdfbookmark[0]{Spis listingw}{spisListingow.1} %
%%\phantomsection
%%\addcontentsline{toc}{chapter}{Spis listingw}
\lstlistoflistings*
\clearpage

\include{skroty} %skrty mona sobie pomin
